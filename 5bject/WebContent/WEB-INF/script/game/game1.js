$(document).ready(function() {
	...
	$("#okBtn").on("click", function() {
		...
		if ( verificationArray.length == 0 ) {
			window.open("/5bject/game/game_correctPop.do", "pop", "width=auto, height=auto, top=50, left=150");
		//오답시   
		} else {
			window.open("/5bject/game/game_incorrectPop.do", "pop", "width=auto, height=auto, top=50, left=150");
		}
	});
